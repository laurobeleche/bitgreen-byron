...
In order to support loading of multiple wallets in byron-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is byron.cpp.
...
Changes to byron.cpp
----------------------
byron.cpp is the entry point into byron-qt, and as such, will require some minor modifications to provide hooks for
